...
<div id="column-main">
    ...
    <ul class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
        ...
        <li typeof="v:Breadcrumb"><h2>Đăng ký</h2></li>
    </ul>
</div>
<section id="page_login">
    ...
    <!--     <div class="row_fg">
        ...
        <div class="panel-body">
                    <form class="form-horizontal frmRegister" method="POST" action="{{ route('register') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            <div class="col-md-6 col-md-offset-4">
                                <button type="submit" class="btnRegister btn">
                                    Đăng ký
                                </button>
                            </div>
                        </div>
