                        ...
                        <div id="tab-profile" class="tab-content">
                                    ...
                                    <li><strong>VỊ TRÍ TUYỂN DỤNG</strong>
                                        ...
                                        <ul class="edit-info">
                                            <li><span class="required">Vị trí tuyển dụng</span>
                                                ...
                                                <select name="job_content_id" >
                                                    <option>-- Chọn công việc --</option>
                                                    @foreach (Data::getJobsContents() as $JobContent)
                                    ...
                                    <li><strong>YÊU CẦU CÔNG VIỆC</strong>
                                        <ul class="edit-info">
                                            ...
                                            <li><span class="required">Mô tả công việc</span>
                                                <textarea name="description" id="fdescription" rows="5"></textarea>
                                            </li>
                                            <li><span>Các kỹ năng yêu cầu</span>
                                                <textarea name="skin" id="frequirement" rows="5"></textarea>
                                            </li>
                                            <li><span>Quyền lợi</span>
                                                <textarea name="benefit" id="fbenefit" rows="5"></textarea>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
                            ...
                            <div class="posting-box">
                                        ...
                                        <li>
                                            <ul class="edit-info">
                                                <li><span class="required">Email liên hệ</span>
                                                    <input name="femails" id="femails" type="text" value="{{Auth::user()->email}}" readonly="">
                                                </li>
                                                <li><span class="required">Điện thoại liên hệ</span>
                                                    <input name="fphone" id="fphone" type="text" value="{{Auth::user()->mobile}}" readonly="">
                                ...
                                <div class="contactguide">
                                    ...
                                    <textarea name="guide" id="fcontactguide" rows="8"></textarea>
                                </div>
                            </div>
